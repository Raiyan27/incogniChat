    ...
    >
      ...
      >
        ...
        <div className="flex gap-3 justify-end">
          <button
            onClick={onCancel}
            className="cyber-button px-5 py-3 md:px-4 md:py-2 min-h-12 md:min-h-0 text-sm font-bold uppercase tracking-wider font-mono hover:scale-105 transition-transform touch-manipulation active:scale-95"
          >
            {cancelText}
          </button>
          <button
            ...
            } px-5 py-3 md:px-4 md:py-2 min-h-12 md:min-h-0 text-sm font-bold uppercase tracking-wider font-mono hover:scale-105 transition-transform touch-manipulation active:scale-95`}
          >
            {confirmText}
          </button>
        </div>
